...
async function main() {
  ...
  const posts: Array<{ type: string; content: string }> = [
    ...
    },
    {
      type: 'blog',
      content:
        '🎸 Артисты на Moooza\n\nЕсли ты в группе, дуэте или соло-проекте — создай профиль артиста. После верификации (нужно разместить код в описании ВК/Instagram артиста) он появится в каталоге. Добавляй релизы, клипы, участников — это твоё лицо в индустрии.',
    },
    {
      type: 'blog',
      content:
