...
- Name: notifications_nav.spec.ts >> Info modal >> X button closes info modal
- Location: tests\playwright\notifications_nav.spec.ts:509:7
  ...
  - generic [ref=e3]:
    ...
    - navigation [ref=e1029]:
      - generic [ref=e1030]:
        ...
        - link "Друзья" [ref=e1049]:
          - /url: /friends
          - img [ref=e1051]
          - generic [ref=e1056]: Друзья
        - link "Профиль" [ref=e1057]:
          - /url: /profile
          - img [ref=e1059]
          - generic [ref=e1062]: Профиль
  - generic [ref=e1064]:
    - generic [ref=e1066]:
      - generic [ref=e1067]:
        - img [ref=e1068]
        - heading "О Moooza" [level=2] [ref=e1071]
      - button [ref=e1072] [cursor=pointer]:
        - img [ref=e1073]
    - generic [ref=e1076]:
      - generic [ref=e1077]:
        - generic [ref=e1078]: Версия
        - generic [ref=e1079]: "1.0"
      - link "Пользовательское соглашение" [ref=e1080]:
        - /url: /terms
        - img [ref=e1081]
        - generic [ref=e1084]: Пользовательское соглашение
      - link "Политика конфиденциальности" [ref=e1085]:
        - /url: /privacy
        - img [ref=e1086]
        - generic [ref=e1088]: Политика конфиденциальности
      - button "Начать онбординг заново" [ref=e1089] [cursor=pointer]:
        - img [ref=e1090]
        - generic [ref=e1092]: Начать онбординг заново
      - link "Служба поддержки support@moooza.ru" [ref=e1093]:
        - /url: mailto:support@moooza.ru
        - img [ref=e1094]
        - generic [ref=e1097]:
          - paragraph [ref=e1098]: Служба поддержки
          - paragraph [ref=e1099]: support@moooza.ru
      - link "Написать в поддержку Telegram" [ref=e1100]:
        - /url: https://t.me/moooza_support
        - img [ref=e1101]
        - generic [ref=e1103]:
          - paragraph [ref=e1104]: Написать в поддержку
          - paragraph [ref=e1105]: Telegram
      - paragraph [ref=e1106]: © 2026 Moooza — Социальная сеть для музыкантов
```
