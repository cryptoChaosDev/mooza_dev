...
export const artistAPI = {
  ...
  lookupReleases: (params: { itunesId?: number | null; deezerId?: number | null; ymId?: string | null }) => api.get('/artist-lookup/releases', { params }),
...
export const orderAPI = {
  ...
  forService: (serviceId: string) => api.get(`/orders/for-service/${serviceId}`),
