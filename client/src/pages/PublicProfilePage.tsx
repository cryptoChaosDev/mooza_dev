        ...
        <div className="px-4">
          <div className="flex items-end justify-between -mt-14 mb-4">
            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              {!currentUser && (
                <Link to="/login" className="flex items-center gap-1.5 px-4 py-2 bg-primary-600 hover:bg-primary-500 text-white text-sm font-medium rounded-xl transition-all">
                  <LogIn size={15} />Войти
                </Link>
              )}
            </div>
          ...
          {user.channel && (
            <div className="px-4 py-4">
              ...
              {currentUser ? (
                ...
                <Link to="/login" className="w-full py-2.5 text-sm font-semibold rounded-xl bg-primary-600 hover:bg-primary-500 text-white flex items-center justify-center gap-2 transition-all">
