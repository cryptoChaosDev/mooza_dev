...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    features: [
      { icon: '🎸', text: 'Профессии и услуги с фильтрами' },
  ...
  },
  {
    emoji: '🔗',
    title: 'Связи',
    description: 'Устанавливайте профессиональные связи с коллегами. Укажите, кем вы выступаете в сотрудничестве: заказчиком, исполнителем или коллегой.',
    accent: 'from-violet-600/20 to-purple-600/20',
    features: [
      { icon: '📋', text: 'Роль: Заказчик / Исполнитель / Коллега' },
      { icon: '📁', text: 'История всех совместных проектов' },
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-8">
        ...
        <div className="relative w-full max-w-sm">
          {/* Icon */}
          <div className="text-7xl text-center mb-6 leading-none">{slide.emoji}</div>
          ...
          {slide.features && (
            <div className="space-y-3">
              {slide.features.map((f, i) => (
                <div
                  key={i}
                  className="flex items-center gap-3 bg-slate-800/50 border border-slate-700/40 rounded-2xl px-4 py-3"
                >
