        ...
        <div className="relative group">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm border border-slate-700/50 rounded-xl text-sm text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500/50 transition-all"
            />
          </div>
        </div>
          ...
          <div className="space-y-3">
            {filteredConversations.map((conversation) => (
              <button
                ...
                className="w-full group relative overflow-hidden bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm rounded-xl p-3 border border-slate-700/50 hover:border-primary-500/50 transition-all duration-300 shadow-md hover:shadow-primary-500/10 text-left"
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="relative flex-shrink-0">
                    ...
                    {conversation.unreadCount > 0 && (
                      <span className="absolute -top-1 -right-1 bg-primary-500 text-white text-[10px] w-4 h-4 rounded-full flex items-center justify-center font-semibold shadow-lg">
