    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="max-w-5xl mx-auto px-4 pb-24 space-y-6">
          ...
          <div className="relative p-8">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-shrink-0 relative group">
                {user.avatar ? (
                  <img
                    ...
                    className="w-40 h-40 rounded-3xl object-cover shadow-2xl ring-4 ring-primary-500/20"
                  />
                ) : (
                  <div className="w-40 h-40 bg-gradient-to-br from-primary-500 via-primary-600 to-purple-600 rounded-3xl flex items-center justify-center shadow-2xl ring-4 ring-primary-500/20">
              ...
              <div className="flex-1 space-y-5">
                <div>
                  <h1 className="text-4xl md:text-5xl font-bold text-white mb-1 bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent">
                    {user.firstName} {user.lastName}
                  </h1>
                  {user.nickname && (
                    <p className="text-slate-400 text-sm mb-3">@{user.nickname}</p>
                  )}
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    {user.fieldOfActivity && (
                      <div className="flex items-center gap-2 px-4 py-2 bg-primary-500/10 border border-primary-500/30 rounded-xl">
                        ...
                        <span className="text-primary-300 font-medium text-sm">{user.fieldOfActivity.name}</span>
                      </div>
                    )}
                    {user.role && (
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="group bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm rounded-2xl p-5 border border-slate-700/50 hover:border-primary-500/50 transition-all duration-300 hover:scale-105">
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 bg-primary-500/10 rounded-lg"><Sparkles size={20} className="text-primary-400" /></div>
            </div>
          ...
          <div className="group bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm rounded-2xl p-5 border border-slate-700/50 hover:border-purple-500/50 transition-all duration-300 hover:scale-105">
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 bg-purple-500/10 rounded-lg"><MessageCircle size={20} className="text-purple-400" /></div>
            </div>
          ...
          <div className="group bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm rounded-2xl p-5 border border-slate-700/50 hover:border-pink-500/50 transition-all duration-300 hover:scale-105">
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 bg-pink-500/10 rounded-lg"><Star size={20} className="text-pink-400" /></div>
            </div>
            <p className="text-3xl font-bold text-white mb-1">{user.userProfessions?.length || 0}</p>
          ...
          <div className="group bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm rounded-2xl p-5 border border-slate-700/50 hover:border-blue-500/50 transition-all duration-300 hover:scale-105">
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 bg-blue-500/10 rounded-lg"><Music size={20} className="text-blue-400" /></div>
            </div>
            <p className="text-3xl font-bold text-white mb-1">{user.userArtists?.length || 0}</p>
            <p className="text-sm text-slate-400">Артистов</p>
          </div>
        </div>
        ...
        {user.userProfessions && user.userProfessions.length > 0 && (
          <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 bg-primary-500/10 rounded-lg"><Star size={24} className="text-primary-400" /></div>
        ...
        {user.userArtists && user.userArtists.length > 0 && (
          <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 bg-purple-500/10 rounded-lg"><Music2 size={24} className="text-purple-400" /></div>
              <h2 className="text-2xl font-bold text-white">Артисты / Группы</h2>
            </div>
            <div className="flex flex-wrap gap-3">
              {user.userArtists.map((ua: any) => (
                <span
                  key={ua.id}
                  className="px-5 py-2.5 bg-gradient-to-br from-purple-500/20 to-purple-600/20 border border-purple-500/30 text-purple-300 rounded-xl text-sm font-medium transition-all hover:scale-105"
                >
                  {ua.artist?.name}
                </span>
              ))}
        ...
        {user.employer && (
          <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 bg-green-500/10 rounded-lg"><Building2 size={24} className="text-green-400" /></div>
              <h2 className="text-2xl font-bold text-white">Работодатель</h2>
            </div>
        ...
        {user.genres && user.genres.length > 0 && (
          <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 bg-primary-500/10 rounded-lg"><Music2 size={24} className="text-primary-400" /></div>
        ...
        {(user.vkLink || user.youtubeLink || user.telegramLink) && (
          <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 bg-blue-500/10 rounded-lg"><Send size={24} className="text-blue-400" /></div>
              <h2 className="text-2xl font-bold text-white">Социальные сети</h2>
            </div>
            <div className="flex flex-wrap gap-3">
              {user.vkLink && (
                <a href={user.vkLink} target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-2 px-5 py-3 bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/30 text-blue-300 rounded-xl transition-all hover:scale-105">
              ...
              {user.youtubeLink && (
                <a href={user.youtubeLink} target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-2 px-5 py-3 bg-red-500/10 hover:bg-red-500/20 border border-red-500/30 text-red-300 rounded-xl transition-all hover:scale-105">
                  <Youtube size={20} />
              ...
              {user.telegramLink && (
                <a href={user.telegramLink} target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-2 px-5 py-3 bg-sky-500/10 hover:bg-sky-500/20 border border-sky-500/30 text-sky-300 rounded-xl transition-all hover:scale-105">
                  <Send size={20} />
